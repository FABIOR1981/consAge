...
export async function initInforme() {
    ...
    // Asegurar existencia del contenedor total
    if (!totalHorasDiv) {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (!Array.isArray(data) && data && data.reservas) {
                // legacy: if backend returns {reservas: [...]}
            ...
            // data is array of simplified rows
    ...
    function renderReservasTable(reservas, tablaEl, totalDiv) {
        // Calcula totales y pinta tabla detallada
